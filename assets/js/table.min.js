...
(function (l) {
        ...
        if (-1 !== l.inArray(!1, c)) V(a, !1);
            ...
            if (0 !== k.length)
                ...
                (e = f.sZeroRecords),
                    ...
                    (c[0] = l("<tr/>", { class: h ? d[0] : "" }).append(l("<td />", { valign: "top", colSpan: oa(a), class: a.oClasses.sRowEmpty }).html(e))[0]);
    ...
    function Za(a) {
        ...
        if (d || (!t && !h && !e && g == oa(a) && g == m.length)) for (v = 0; v < g; v++) (k = ta(a, v)), null !== k && (c[k].sWidth = K(m.eq(v).width()));
        else {
    ...
    function Da(a, b) {
        ...
        b <= c
            ...
            : (a >= b - 1 - d ? (a = qa(b - (c - 2), b)) : ((a = qa(a - d + 2, a + d - 1)), a.push("ellipsis"), a.push(b - 1)), a.splice(0, 0, "ellipsis"), a.splice(0, 0, 0));
        a.DT_el = "span";
        return a;
    }
    function Xa(a) {
    ...
    var zc = function (a, b, c, d) {
        ...
        rc = function (a, b) {
            ...
            if (c.length && a.length) {
                ...
                d._details &&
                    ((d._detailsShow = b) ? (d._details.insertAfter(d.nTr), l(d.nTr).addClass("dt-hasChild")) : (d._details.detach(), l(d.nTr).removeClass("dt-hasChild")), F(c[0], null, "childRow", [b, a.row(a[0])]), Ac(c[0]), qc(c));
            }
        },
        Ac = function (a) {
            var b = new B(a),
    ...
    y("search()", function (a, b, c, d) {
        ...
        return a === q
            ...
            : this.iterator("table", function (h) {
                  h.oFeatures.bFilter && ya(h, l.extend({}, h.oPreviousSearch, { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === d ? !0 : d }), 1);
              });
    });
    J("columns().search()", "column().search()", function (a, b, c, d) {
        return this.iterator("column", function (e, h) {
            ...
            e.oFeatures.bFilter && (l.extend(f[h], { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === d ? !0 : d }), ya(e, e.oPreviousSearch, 1));
        });
    });
    y("state()", function () {
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: '<div class="text-center"><img src="/assets/img/icon/7438816.png" width="120px" height="120px"><p class="font-weight-bold">Không tìm thấy danh sách...</p></div>',
            sInfo: "Hiển thị _START_ đến _END_ trong số _TOTAL_ mục",
            sInfoEmpty: "Hiển thị 0 đến 0 trong số 0 mục",
            sInfoFiltered: "(được lọc từ tổng số  _MAX_ total mục)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "_MENU_",
            ...
            sUrl: "",
            sZeroRecords: '<div class="text-center"><img src="/assets/img/icon/7438816.png" width="120px" height="120px"><p class="font-weight-bold">Không tìm thấy kết quả...</p></div>',
        },
...
(function (a) {
    ...
    a.extend(!0, d.defaults, { dom: "<'row'<'col-lg-6'l><'col-lg-6'f>><'row'<'table-responsive'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>", renderer: "bootstrap" });
